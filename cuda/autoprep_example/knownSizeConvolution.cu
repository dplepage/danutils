...
////////////////////////////////////////////////////////////////////////////////
#define KERNEL_RADIUS {{ radius | default(8) }}
...
#define            ROW_TILE_W {{ row_tile_w | default(128) }}
#define KERNEL_RADIUS_ALIGNED {{ radius_aligned | default(16) }}

// Assuming COLUMN_TILE_W and dataW are multiples
// of coalescing granularity size, all global memory operations 
// are coalesced in convolutionColumnGPU()
#define COLUMN_TILE_W {{ column_tile_w | default(16) }}
#define COLUMN_TILE_H {{ column_tile_h | default(48) }}
...
////////////////////////////////////////////////////////////////////////////////
{{ reg.function(
    name = "convolutionRowGPU",
    sig = "2P",
    block = (radius_aligned + row_tile_w + radius,),
...
#define smemStride {{ column_tile_w * 8 }}
#define gmemStride {{ data_w * 8}}
}}
...
////////////////////////////////////////////////////////////////////////////////
{{ reg.function(
    name = "convolutionColumnGPU",
    sig = "2P",
    block = (column_tile_w, 8),
    grid = (iDivUp(data_w, column_tile_w), iDivUp(data_h, column_tile_h)),
    )
}}
